# The name of this view in Looker is "Integrations All"
view: integrations_all {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "PC_STITCH_DB"."PRODUCTION_APPLICATION"."INTEGRATIONS_ALL"
    ;;
  drill_fields: [id]
  ...
  dimension_group: connected {
    ...
    sql: CAST(${TABLE}."CONNECTED_AT" AS TIMESTAMP_NTZ) ;;
  }
