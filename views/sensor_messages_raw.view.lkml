# The name of this view in Looker is "Sensor Messages Raw"
view: sensor_messages_raw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "PUBLIC"."SENSOR_MESSAGES_RAW"
    ;;
  drill_fields: [id]
  ...
  measure: count {
    type: count
    drill_fields: [id, filename, hardware.id]
  }
