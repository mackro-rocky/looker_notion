...
view: shipments {
  ...
  sql_table_name: "PC_STITCH_DB"."PRODUCTION_APPLICATION"."SHIPMENTS"
    ;;
  drill_fields: [id]
  ...
  dimension_group: shipment {
    ...
    sql: CAST(${TABLE}."SHIPMENT_DATE" AS TIMESTAMP_NTZ) ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, orders.id, hardware_shipments_all.count]
  }
}
