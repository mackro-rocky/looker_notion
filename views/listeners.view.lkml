# The name of this view in Looker is "Listeners"
view: listeners {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "PUBLIC"."LISTENERS"
    ;;
  drill_fields: [id]
  ...
  set: detail {
    fields: [
      ...
      task_types.name,
      task_types.id,
      model_states_sensor_raw.count,
      task_alert_preferences.count,
      thresholds.count,
      webhooks_listener.count
    ]
  }
}
