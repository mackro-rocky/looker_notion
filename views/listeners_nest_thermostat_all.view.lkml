# The name of this view in Looker is "Listeners Nest Thermostat All"
view: listeners_nest_thermostat_all {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "PUBLIC"."LISTENERS_NEST_THERMOSTAT_ALL"
    ;;
  drill_fields: [id]
  ...
  dimension: nest_thermostat_id {
    type: string
    sql: ${TABLE}."NEST_THERMOSTAT_ID" ;;
  }
